...
void wautopersonal::on_vstavkadata_clicked()
{
...
void wautopersonal::on_personal_clicked(const QModelIndex &index)
{
    int temp_nom = ui->personal->model()->data(ui->personal->model()->index(index.row(),0)).toInt();
    ui->apid->setText(QString::number(temp_nom));

    QString temp_nom2 = ui->personal->model()->data(ui->personal->model()->index(index.row(),1)).toString();
    ui->name->setText(temp_nom2);

    QString temp_nom3 = ui->personal->model()->data(ui->personal->model()->index(index.row(),2)).toString();
    ui->lastname->setText(temp_nom3);

    QString temp_nom4 = ui->personal->model()->data(ui->personal->model()->index(index.row(),3)).toString();
    ui->thirdname->setText(temp_nom4);
}
